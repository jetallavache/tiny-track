...
static void test_cross_process_read(void) {
    ...
    CHECK("latest cpu_usage = N_SAMPLES*10",
          out.cpu_usage == (uint16_t)(N_SAMPLES * 10));
    CHECK("latest net_rx = N_SAMPLES*100",
          out.net_rx == (uint32_t)(N_SAMPLES * 100));
