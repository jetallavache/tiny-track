#ifndef SRC_SERVER_NET_H
#define SRC_SERVER_NET_H
...
struct s_conn {
  ...
  // struct s_iobuf prof; /* Данные профиля, включены с помощью
  // MG_ENABLE_PROFILE */ struct s_iobuf rtls; /* TLS only. Входящие
